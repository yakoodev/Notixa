...
public sealed class PlatformAdministrationServiceTests
{
    ...
    public async Task RedeemInviteAsync_SupportsGeneralInvite()
    {
        ...
        Assert.Equal(TelegramNotifications.Api.Contracts.RedeemInviteStatus.Created, redeem.Status);
    ...
    public async Task RedeemInviteAsync_RejectsExpiredOrDepletedInvite()
    {
        ...
        Assert.Equal(TelegramNotifications.Api.Contracts.RedeemInviteStatus.Created, first.Status);
        Assert.Equal(TelegramNotifications.Api.Contracts.RedeemInviteStatus.Invalid, second.Status);
        ...
        Assert.Equal(TelegramNotifications.Api.Contracts.RedeemInviteStatus.Invalid, expired.Status);
    }
    ...
    public async Task RedeemInviteAsync_DoesNotOverwriteExistingSubscription()
    {
        ...
        Assert.Equal(TelegramNotifications.Api.Contracts.RedeemInviteStatus.Created, firstRedeem.Status);
        Assert.Equal(TelegramNotifications.Api.Contracts.RedeemInviteStatus.AlreadySubscribed, secondRedeem.Status);
